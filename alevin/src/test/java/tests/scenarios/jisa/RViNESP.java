...
@Ignore
public class RViNESP extends AbstractLoadScenarioTest {
    public RViNESP(ScenarioData data) {
        super(data);
    }
    ...
    public void runAlgorithm() {
        ...
        String path = System.getProperty("user.home") + File.separator + "Evaluation-results_" + scenario_suffix + "-RViNESP.csv";
        List<EvaluationMetric> metrics = new LinkedList<EvaluationMetric>();
        IAlgorithm algo = new CoordinatedMappingkShortestPath(ToolKit
                .getScenario().getNetworkStack(), 40, 1, 1, 1, 20, false);
