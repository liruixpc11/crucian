...
@Ignore
public class GARPS extends AbstractLoadScenarioTest {
    public GARPS(ScenarioData data) {
        super(data);
    ...
    public void runAlgorithm() {
		 ...
		 * Rounding Type: Randomized rounding 
        ...
        IAlgorithm algo = new AvailableResourcesPathSplitting(ToolKit
                .getScenario().getNetworkStack(), 1, 1, 35, false, false);
    ...
    protected void evaluate(String scenario_suffix, long elapsedTime) {
        ...
        String path = System.getProperty("user.home") + File.separator + "GARPS-test" + File.separator + "Evaluation-results_" + scenario_suffix + "-GARPS.csv";
