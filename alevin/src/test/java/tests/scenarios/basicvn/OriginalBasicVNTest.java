...
@Ignore
public final class OriginalBasicVNTest extends AbstractNoLoadScenarioTest {

    private final PrintWriterDataReceiver writer;

    public OriginalBasicVNTest(ScenarioData data) throws IOException {
        super(data);

        writer = new PrintWriterDataReceiver(
                new PrintWriter(new FileWriter(
                        OriginalBasicVNTest.class.getSimpleName() + "_out.txt", true),
                        true));
