...
@Ignore
public final class BasicVNWOBandwidthTest extends AbstractNoLoadScenarioTest {

    private final PrintWriterDataReceiver writer;

    public BasicVNWOBandwidthTest(ScenarioData data) throws IOException {
        super(data);

        writer = new PrintWriterDataReceiver(
                new PrintWriter(new FileWriter(
                        BasicVNWOBandwidthTest.class.getSimpleName() + "_out.txt", true),
                        true));
