...
@Ignore
public final class BasicVNLinkStressTest extends AbstractNoLoadScenarioTest {

    private final PrintWriterDataReceiver writer;

    public BasicVNLinkStressTest(ScenarioData data) throws IOException {
        super(data);

        writer = new PrintWriterDataReceiver(
                new PrintWriter(new FileWriter(
                        BasicVNLinkStressTest.class.getSimpleName() + "_out.txt", true),
                        true));
