...
@Ignore
public final class BasicVNTest extends AbstractNoLoadScenarioTest {

    private final PrintWriterDataReceiver writer;

    public BasicVNTest(ScenarioData data) throws IOException {
        super(data);

        writer = new PrintWriterDataReceiver(
                new PrintWriter(new FileWriter(
                        BasicVNTest.class.getSimpleName() + "_out.txt", true),
                        true));
    ...
    public void generateCPUResourcesAndDemands(NetworkStack stack,
        ...
        AbstractNoLoadScenarioTest.generateRandomCPUResourcesAndDemands(stack, minResourceCPU, maxResourceCPU, minDemandCPU, maxDemandCPU);
    }
    ...
    public void generateBandwidthResourceAndDemands(NetworkStack stack,
        ...
        AbstractNoLoadScenarioTest.generateRandomBandwidthResourceAndDemands(stack, minResourceBandwidth, maxResourceBandwidth, minDemandBandwidth, maxDemandBandwidth);
    }
    ...
    protected void evaluate(String scenarioSuffix, long elapsedTime) {
        ...
        MiscelFunctions.sortByRevenues(stack);
