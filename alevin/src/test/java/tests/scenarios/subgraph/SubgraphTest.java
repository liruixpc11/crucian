...
@Ignore
public final class SubgraphTest extends AbstractNoLoadScenarioTest {
    ...
    public SubgraphTest(ScenarioData data) throws IOException {
        super(data);

        writer = new PrintWriterDataReceiver(
                new PrintWriter(new FileWriter(
                        SubgraphTest.class.getSimpleName() + "_out.txt", true),
                        true));
    ...
    public void generateBandwidthResourceAndDemands(NetworkStack stack,
        ...
        AbstractNoLoadScenarioTest.generateRandomBandwidthResourceAndDemands(stack,
