...
public final class SimpleDijkstraAlgorithmTest {
    ...
    public void algorithmTest() {
        ToolKit.getScenario().setNetworkStack(
                new NetworkStack(createSubstrate(), createVNDemands()));

        System.out.println(ToolKit.getScenario().getNetworkStack()
                .getSubstrate());

        IAlgorithm algo = new SimpleDijkstraAlgorithm(ToolKit.getScenario()
                .getNetworkStack());
