 ...
 */
@Ignore
public class PathSplittingAlgorithmTest {
    @Test
    public void algorithmTest() {
        ...
        AvailableResourcesPathSplitting algo1 = new AvailableResourcesPathSplitting(
                stack, 1, 1, 200, false, false);
        ...
        metrics.add(new TotalRevenue(true));
