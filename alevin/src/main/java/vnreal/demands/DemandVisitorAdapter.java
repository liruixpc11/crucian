...
public abstract class DemandVisitorAdapter {
    ...
    public boolean visit(EnergyDemand energyDemand) {
        return false;
    }

    public boolean visit(MultiCoreEnergyDemand energyDemand) {
        return false;
    }

    public boolean visit(StaticEnergyDemand energyDemand) {
        return false;
    }
}
