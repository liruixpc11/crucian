...
public final class MultiCoreEnergyDemand extends AbstractDemand implements
        INodeConstraint {
    public MultiCoreEnergyDemand(Node<? extends AbstractConstraint> owner) {
        super(owner);
    }
    ...
    public String toString() {
        return new String("MultiCoreEnergyDemand");
    }
}
