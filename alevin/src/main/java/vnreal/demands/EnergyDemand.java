...
public class EnergyDemand extends AbstractDemand implements
        INodeConstraint {

    public EnergyDemand(Node<? extends AbstractConstraint> owner) {
        super(owner);
    }
    ...
    protected ResourceVisitorAdapter createAcceptsVisitor() {
        return new ResourceVisitorAdapter() {
            @Override
            public boolean visit(EnergyResource res) {
                return true;
            }
        };
    }
    ...
    public String toString() {
        return new String("EnergyDemand");
    }
}
