...
/**
 * Class to obtain the total revenue that could be obtained of the stack of virtual networks requests.
 * <p/>
 * This revenue sums the revenue of the VNRs that were successfully mapped and the revenue of those that
 * were not mapped.
 *
