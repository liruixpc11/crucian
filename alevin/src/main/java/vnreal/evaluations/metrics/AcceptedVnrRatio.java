...
/**
 * Class to obtain the ratio of accepted Virtual Network Request
...
public class AcceptedVnrRatio extends AbstractEvaluation {
    ...
    /**
     * This method calculates the ratio of accepted virtual
     * networks, dividing the number of accepted VNRs
     * by the total number of VNRs
     */
    @Override
    public double calculate() {
        RejectedNetworksNumber numRej = new RejectedNetworksNumber();
        numRej.setStack(stack);
        double acceptedRatio = (((stack.size() - 1) - numRej.getValue()) / (stack.size() - 1)) * 100;
