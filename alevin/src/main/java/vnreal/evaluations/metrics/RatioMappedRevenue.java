 ...
 * <p/>
 * This metric measures the percentage of mapped revenue. It is calculated
 * by dividing the mapped revenue over the total revenue.
 *
 * @author Juan Felipe Botero
 * @since 2011-03-08
 */

public class RatioMappedRevenue extends AbstractEvaluation {
    ...
    public double calculate() {
        ...
        totalRev.setStack(stack);
        double revRatio = (rev.getValue() / totalRev.getValue()) * 100;
        return (revRatio);
    }
