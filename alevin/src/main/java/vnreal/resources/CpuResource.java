 ...
 * @since 2010-09-10
 */
public class CpuResource extends AbstractResource implements
        INodeConstraint {
    ...
    protected void setOccupiedCycles(double occupiedCycles) {
    ...
    public AbstractResource getCopy(NetworkEntity<? extends AbstractConstraint> owner) {
        ...
        CpuResource clone = new CpuResource((Node<? extends AbstractConstraint>) owner);
        clone.cycles = cycles;
