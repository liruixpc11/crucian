...
public abstract class AbstractResource extends AbstractConstraint {
    ...
    /**
     * Has to be implemented in sub-classes, such that the type of Demand can
     * be properly resolved.
     *
     * @param dem The demand to be accepted.
     ...
     * be properly resolved.
     *
     * @param dem The demand to be fulfilled.
    ...
    public abstract AbstractResource getCopy(NetworkEntity<? extends AbstractConstraint> owner);
