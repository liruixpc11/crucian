 ...
 * @since 2010-09-10
 */
public class BandwidthResource extends AbstractResource implements
        ILinkConstraint {
    ...
    protected void setOccupiedBandwidth(double value) {
        occupiedBandwidth = value;
    }
    ...
    public AbstractResource getCopy(NetworkEntity<? extends AbstractConstraint> owner) {
        ...
        BandwidthResource clone = new BandwidthResource((Link<? extends AbstractConstraint>) owner);
