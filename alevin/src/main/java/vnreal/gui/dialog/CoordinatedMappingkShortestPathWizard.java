...
public class CoordinatedMappingkShortestPathWizard extends AbstractButtonDialog {
    ...
    protected JPanel createContent() {
        ...
        snHorizontal.addGroup(snLayout.createParallelGroup().addComponent(
                maxDistLabel).addComponent(cpuWLabel).addComponent(bwWLabel)
                .addComponent(kLabel).addComponent(typeLabel).addComponent(
                        nodeOverloadLabel));
        snHorizontal.addGroup(snLayout.createParallelGroup().addComponent(
                maxDistSpinner, GroupLayout.PREFERRED_SIZE,
        ...
        snVertical.addGroup(snLayout.createParallelGroup(
                GroupLayout.Alignment.CENTER).addComponent(typeLabel)
                .addComponent(deterministicButton, GroupLayout.PREFERRED_SIZE,
                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE));
    ...
    protected void doAction() {
        ...
        IAlgorithm coordinatedMappingkShortestPath = null;
        ...
        if (!deterministicButton.isSelected() && !randomizedButton.isSelected()) {
            ...
            coordinatedMappingkShortestPath = new CoordinatedMappingkShortestPath(
        ...
        new MyProgressBarDialog(coordinatedMappingkShortestPath);
