...
public final class MappingTreeModel implements TreeModel {
    ...
    protected class VirtualLinkProxy extends LinkProxy {
        ...
        @Override
        public Object getChildAt(int index) {
            return new MappingProxy(getMappings().get(index));
        }
    ...
    protected class SubstrateLinkProxy extends LinkProxy {
        ...
        public SubstrateLinkProxy(SubstrateLink link) {
            this.link = link;
            this.substrate = ToolKit.getScenario().getNetworkStack()
                    .getSubstrate();
        }
    ...
    private class VirtualNetworksProxy implements IProxy {
        ...
        public int getChildCount() {
            if (ToolKit.getScenario().getNetworkStack() == null)
                ...
                return ToolKit.getScenario().getNetworkStack().size() - 1;
        }

        @Override
        public Object getChildAt(int index) {
            // index +1 due to SubstrateNetwork (layer 0)
            return new VirtualNetworkProxy((VirtualNetwork) ToolKit
                    .getScenario().getNetworkStack().getLayer(index + 1));
        }
    ...
    private class SubstrateNetworkProxy implements IProxy {
        ...
        @Override
        public Object getChildAt(int index) {
            SubstrateNetwork substrate = ToolKit.getScenario()
