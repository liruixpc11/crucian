 ...
 * the coordinated node mapping in the node mapping stage and k shortest paths 
 * in link mapping
 *
 *
...
public class CoordinatedMappingkShortestPath extends GenericMappingAlgorithm {
    public CoordinatedMappingkShortestPath(NetworkStack stack, int dist,
                                           double wCpu, double wBw, int type, int k, boolean nodeOverload) {
