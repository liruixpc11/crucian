...
/**
 * Modification of the Breadth First search algorithm implementation
 * from http://blog.konem.net/java//index.php/2007/11/15/breadth_first_search_algorithm_in_java_w?blog=1
 * <p/>
 * To find a path inside a subgraph of the Substrate Network
 * by:
 *
...
public class BreadthFirstSearch {
    ...
    public BreadthFirstSearch(Set<SubstrateLink> substrateLinks,
                              int sourceNodeId, int targetNodeId, SubstrateNetwork sNet) {
    ...
    public List<SubstrateLink> search() {
        while (!foundRelation && queue.getSize() > 0) {
            ...
            SubstrateNode node = getNodeFromSubstrateNetwork(queueItem
                    .getNodeId(), sNet);
    ...
    private SubstrateNode getNodeFromSubstrateNetwork(int nodeId,
