...
public abstract class GenericMappingAlgorithm extends
    ...
    private int processedLinks, mappedLinks;
    private AbstractNodeMapping nodeMappingAlgorithm;
    private AbstractLinkMapping linkMappingAlgorithm;
    private double startTime, runningTime;
     ...
     *
     * @param stack       of networks VNRs and Substrate
     * @param implemented nodeMappingAlgorithm
     * @param implemented linkMappingAlgorithm
     */
    ...
    protected boolean process(VirtualNetwork p) {
        ...
        // Link Mapping stage
        if (!linkMappingAlgorithm.linkMapping(p,
                nodeMappingAlgorithm.getNodeMapping())) {
            stack.clearVnrMappings(p);
        } else {
